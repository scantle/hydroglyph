...
class RavenTimeSeriesBlock extends React.Component {
  ...
  render() {
    ...
    const {okey, onClose, noClose, rangeUpdate, dateRange} = this.props;
    const cssFix = {width: '95%', marginLeft: 'auto', marginRight: 'auto'};
    ...
    return(
      <div>
        ...
        {data !== null && <ResizableBox style={cssFix}
                                        ...
                                        axis="y"
                                        width={1000} height={pHeight+30}>
                          <Segment.Group raised horizontal style={{height: pHeight + 30}}>
